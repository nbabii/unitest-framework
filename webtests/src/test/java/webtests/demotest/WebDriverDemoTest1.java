...
public class WebDriverDemoTest1 extends WebTestBase {

	private static final FrameworkLogger LOG = LogFactory
			.getLogger(WebDriverDemoTest1.class);
	...
	@Test
	public void searchEleksTest6() throws IOException {
